...
$title = $guide['title'] ?? 'Chick Care Guide';
...
<div class="care-container">
    <div class="care-header text-center mb-4">
        <img src="assets/images/13_acf3092d55de05d63ce6ae348020dd7c.png" alt="Chick" class="mb-2">
        <h1><?= htmlspecialchars($title) ?></h1>
        <div class="text-muted">Stage: 0-5 months</div>
    </div>
    <div class="mb-4">
        <?= $content ?>
    </div>
