...
$title = $guide['title'] ?? 'Stag Care Guide';
...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #e6fff7 60%, #b2f7ef 100%);
            min-height: 100vh;
        }
        .care-container {
            max-width: 420px;
...
<div class="care-container">
    <div class="care-header text-center mb-4">
        <img src="assets/images/18_61496d451a10a4247e0a420556f42e68.png" alt="Stag" class="mb-2">
        <h1><?= htmlspecialchars($title) ?></h1>
        <div class="text-muted">Stage: 5-9 months</div>
    </div>
    <div class="mb-4">
        <?= $content ?>
    </div>
