...
$title = $guide['title'] ?? 'Rooster Care Guide';
...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #e6f7ff 60%, #b3e0ff 100%);
            min-height: 100vh;
        }
        .care-container {
            max-width: 420px;
...
<div class="care-container">
    <div class="care-header text-center mb-4">
        <img src="assets/images/14.png" alt="Rooster" class="mb-2">
        <h1><?= htmlspecialchars($title) ?></h1>
        <div class="text-muted">Stage: 9+ months</div>
    </div>
    <div class="mb-4">
        <?= $content ?>
    </div>
